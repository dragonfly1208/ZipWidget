...
public:
    static QStringList extractDir(QuaZip &zip, const QString &dir,const QString &parentZipDir = QString());
    ...
    static bool compressSubDir(QuaZip* parentZip, QString dir, QString parentDir, bool recursive,
                               QDir::Filters filters,const QString &parentZipDir = QString());
...
public:
    ...
    /**
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(QString fileCompressed, QString dir = QString(),const QString &parentZipDir = QString());
    /// Get the file list.
    /**
